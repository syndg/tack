...
func TestBuildGroupsInsightsAndSummarizesCandidates(t *testing.T) {
	...
	}, []domain.CodificationCandidate{{ID: "candidate-1", EvidenceCount: 2}})
...
func TestBuildHandlesEmptyInputs(t *testing.T) {
	...
	if report.ObjectiveID != "obj-empty" || report.Summary.TotalInsights != 0 || len(report.Groups) != 0 || len(report.Candidates) != 0 {
