...
| Agent stuck in a loop | Check `tack logs <agent-id>` and send guidance via `tack mail` |
| Objective blocked | Check `tack mail` for escalations, send guidance to unblock |
