...
See [Recovery & Retries](/docs/concepts/recovery) for the full recovery workflow.
...
Blueprint IDs are resolved from the loaded blueprint registry, including shipped defaults plus any user or project overrides. See [Blueprints](/docs/concepts/blueprints) for how blueprints work.
