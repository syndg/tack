...
Project-aware clients should also send `X-Tack-Project-ID` when targeting a specific registered repo. See the [HTTP API reference](/docs/reference/api) for full endpoint details.
