...
Blocked recovery sends an escalation to your mailbox:
...
For `partial` objectives, you can retry just the failed streams without re-running everything. For `blocked` objectives, send guidance to unblock.
