...
Deck ships two default blueprints:
...
Override defaults by placing your own in `.deck/blueprints/`:
...
Pause execution until a human approves via `deck approve` or the API.
