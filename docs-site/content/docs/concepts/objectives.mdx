...
Before planning, Tack runs a discovery step that explores the codebase and produces a [context dossier](/docs/concepts/discovery) with cited references and suggested seams. The planner consumes this dossier to produce better decompositions.
