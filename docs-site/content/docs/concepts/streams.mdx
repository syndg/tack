...
Streams are the operator-facing execution unit. Each stream carries a persisted execution contract derived from discovery and dossier findings, with contract patches that accumulate as the objective progresses.
