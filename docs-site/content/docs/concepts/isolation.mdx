...
Local sandboxes use git worktrees on your machine. They are fast because there is no network overhead, no VM startup, and files use copy-on-write where available.
